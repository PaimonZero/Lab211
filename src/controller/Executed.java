...
public class Executed extends MyMenu {
    ...
    public Executed() {
        super("\n------------------------------\n***QuickSort and BubbleSort***", 
                new String[] {"Quick sort", "Bubble Sort", "Linear Search", "Binary Search", "Close program!"});
    }
    ...
    public void execute(int choice) {
        ...
        switch (choice) {
            case 1:
                ...
                int sortChoiceQ = Validate.inputIntMinMax(">>Your choice: ",1 ,2);
                ...
                if(sortChoiceQ == 1) {
                    ...
                    sort.QuickSort(arr.getArray(), 0, arr.getSize() - 1);
                    sort.Display(arr.getArray());
            ...
            case 2:
                ...
                System.out.println("1. Generate random integer in number range for each array element.");
                System.out.println("2. User enters each element of the array.");
                int sortChoiceB = Validate.inputIntMinMax(">>Your choice: ",1 ,2);
